        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-800 text-lg px-8 py-4 hover:scale-105 transition-all duration-300 border border-gray-600 shadow-lg"
            >
